...
def test_roughness_params_download_as_txt(
    client, two_topos, file_format, handle_usage_statistics, rf
):
    ...
    ana1 = TopographyAnalysisFactory.create(
        subject_topography=t1, function=func, kwargs=kwargs
    )
    ana2 = TopographyAnalysisFactory.create(
        subject_topography=t1, function=func, kwargs=kwargs
    )
